...
#endif
vec3 l9_18=mix(l9_15.xyz,definedBlend(l9_15.xyz,Port_FinalColor_N004.xyz).xyz,vec3(Port_FinalColor_N004.w));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_23=vec4(mix(vec3(1.0),Port_FinalColor_N004.xyz,vec3(Port_FinalColor_N004.w)),Port_FinalColor_N004.w);
}
#else
{
vec4 l9_24;
...
{
l9_25=clamp(Port_FinalColor_N004.w,0.0,1.0);
}
#else
{
l9_25=Port_FinalColor_N004.w;
}
#endif
l9_24=vec4(Port_FinalColor_N004.xyz*l9_25,l9_25);
}
#else
{
l9_24=Port_FinalColor_N004;
}
#endif
l9_23=l9_24;
}

...
{
l9_142=sc_SampleView(sc_ScreenTextureDims.xy,l9_140,sc_ScreenTextureLayout,l9_141,0.0,sc_ScreenTextureArrSC);
}
#else
{
l9_142=sc_SampleView(sc_ScreenTextureDims.xy,l9_140,sc_ScreenTextureLayout,l9_141,0.0,sc_ScreenTexture);
}
#endif
l9_136=l9_142;
}
...
#if (sc_OITCompositingPass)
{
vec2 l9_166=sc_ScreenCoordsGlobalToView((gl_FragCoord.xy*sc_WindowToViewportTransform.xy)+sc_WindowToViewportTransform.zw);
#if (sc_OITMaxLayers4Plus1)
{

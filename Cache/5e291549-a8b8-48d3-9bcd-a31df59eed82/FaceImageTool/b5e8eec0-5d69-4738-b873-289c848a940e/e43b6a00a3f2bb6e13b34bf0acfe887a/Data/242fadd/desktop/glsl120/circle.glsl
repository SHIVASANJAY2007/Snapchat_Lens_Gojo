...
{
l9_135=strokeColorActive;
}
else
{
l9_135=strokeColorInactive;
}
l9_134=l9_135;
}
#else
...
#endif
vec4 l9_136=mix(mix(mix(l9_114,vec4(Port_Input1_N259),vec4((0.001-0.001)*l9_121)),vec4(shapeColor.xyz,1.0),l9_132),l9_133,vec4(l9_125));
...
#if (sc_FramebufferFetch)
{
vec4 l9_154=sc_readFragData0_Platform();
vec4 l9_155;
#if (sc_UseFramebufferFetchMarker)
{
vec4 l9_156=l9_154;
l9_156.x=l9_154.x+_sc_framebufferFetchMarker;
l9_155=l9_156;
}
#else
{
...
#else
{
vec2 l9_157=sc_ScreenCoordsGlobalToView((gl_FragCoord.xy*sc_WindowToViewportTransform.xy)+sc_WindowToViewportTransform.zw);
int l9_158;
#if (sc_ScreenTextureHasSwappedViews)
{
l9_158=1-sc_GetStereoViewIndex();
}
#else
{
l9_158=sc_GetStereoViewIndex();
}
#endif
l9_153=sc_SampleView(sc_ScreenTextureDims.xy,l9_157,sc_ScreenTextureLayout,l9_158,0.0,sc_ScreenTexture);
}
#endif
vec4 l9_159;
...
{
vec4 l9_160=l9_153;
l9_160.x=l9_153.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_159=l9_160;
}
#else
{
...
#endif
vec3 l9_161=mix(l9_159.xyz,definedBlend(l9_159.xyz,l9_136.xyz).xyz,vec3(l9_137));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_163=vec4(mix(vec3(1.0),l9_136.xyz,vec3(l9_137)),l9_137);
}
#else
{
vec4 l9_164;
...
#endif
l9_164=vec4(l9_136.xyz*l9_165,l9_165);
}
#else
{
l9_164=l9_136;
...
{
l9_168=vec4(shaderComplexityValue/255.0,0.0,0.0,1.0);
}
#else
{
l9_168=vec4(0.0);
...
vec4 l9_170=outputMotionVectorsIfNeeded(varPos,max(l9_169,vec4(0.0)));
vec4 l9_171=clamp(l9_170,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_172=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0(vec4(max(0.0,1.0-(l9_172-0.0039215689)),min(1.0,l9_172+0.0039215689),0.0,0.0));
}
#endif
}
#else
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_173=sc_ScreenCoordsGlobalToView((gl_FragCoord.xy*sc_WindowToViewportTransform.xy)+sc_WindowToViewportTransform.zw);
...
#endif
int l9_174=encodeDepth(viewSpaceDepth(),texture2D(sc_OITFilteredDepthBoundsTexture,l9_173).xy);
float l9_175=packValue(l9_174);
int l9_182=int(l9_171.w*255.0);
float l9_183=packValue(l9_182);
sc_writeFragData0(vec4(packValue(l9_174),packValue(l9_174),packValue(l9_174),packValue(l9_174)));
sc_writeFragData1(vec4(l9_175,packValue(l9_174),packValue(l9_174),packValue(l9_174)));
sc_writeFragData2(vec4(l9_183,packValue(l9_182),packValue(l9_182),packValue(l9_182)));
...
#if (sc_OITCompositingPass)
{
vec2 l9_186=sc_ScreenCoordsGlobalToView((gl_FragCoord.xy*sc_WindowToViewportTransform.xy)+sc_WindowToViewportTransform.zw);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,l9_186).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_191==0)
{
l9_194=texture2D(sc_OITAlpha0,l9_186);
l9_193=texture2D(sc_OITDepthLow0,l9_186);
l9_192=texture2D(sc_OITDepthHigh0,l9_186);
}
else
{
l9_194=vec4(0.0);
...
if (l9_191==1)
{
l9_197=texture2D(sc_OITAlpha1,l9_186);
l9_196=texture2D(sc_OITDepthLow1,l9_186);
l9_195=texture2D(sc_OITDepthHigh1,l9_186);
}
else
{
l9_197=l9_194;
...
if (any(notEqual(l9_195,vec4(0.0)))||any(notEqual(l9_196,vec4(0.0))))
{
int l9_198[8]=l9_187;
unpackValues(l9_195.w,l9_191,l9_198);
unpackValues(l9_195.z,l9_191,l9_198);
unpackValues(l9_195.y,l9_191,l9_198);
unpackValues(l9_195.x,l9_191,l9_198);
unpackValues(l9_196.w,l9_191,l9_198);
unpackValues(l9_196.z,l9_191,l9_198);
unpackValues(l9_196.y,l9_191,l9_198);
unpackValues(l9_196.x,l9_191,l9_198);
int l9_207[8]=l9_188;
unpackValues(l9_197.w,l9_191,l9_207);
unpackValues(l9_197.z,l9_191,l9_207);
unpackValues(l9_197.y,l9_191,l9_207);
unpackValues(l9_197.x,l9_191,l9_207);
}
l9_191++;
continue;
}
...
vec4 l9_212=texture2D(sc_OITFilteredDepthBoundsTexture,l9_186);
vec2 l9_213=l9_212.xy;
int l9_214;
#if (sc_SkinBonesCount>0)
{
l9_214=encodeDepth(((1.0-l9_212.x)*1000.0)+getDepthOrderingEpsilon(),l9_213);
}
#else
{
l9_214=0;
...
#endif
int l9_215=encodeDepth(viewSpaceDepth(),l9_213);
vec4 l9_216;
l9_216=l9_171*l9_171.w;
vec4 l9_217;
int l9_218=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_218<8)
{
int l9_219=l9_187[l9_218];
int l9_220=l9_215-l9_214;
bool l9_221=l9_219<l9_220;
bool l9_222;
if (l9_221)
{
l9_222=l9_187[l9_218]>0;
}
else
{
l9_222=l9_221;
...
if (l9_222)
{
vec3 l9_223=l9_216.xyz*(1.0-(float(l9_188[l9_218])/255.0));
l9_217=vec4(l9_223.x,l9_223.y,l9_223.z,l9_216.w);
}
else
{
l9_217=l9_216;

...
vec4 param_5;
Node30_Switch(0.0,vec4(0.0),vec4(0.0),vec4(0.0),vec4(0.0),param_5,ssGlobals(l9_1,l9_2,0.0,varPackedTex.xy));
vec4 l9_3=param_5;
...
#endif
vec4 l9_32=outputMotionVectorsIfNeeded(varPos,max(l9_4,vec4(0.0)));
...
if (l9_59==0)
{
l9_62=texture2D(sc_OITAlpha0,l9_48);
l9_61=texture2D(sc_OITDepthLow0,l9_48);
l9_60=texture2D(sc_OITDepthHigh0,l9_48);
}
else
{
l9_62=l9_55;
...
if (l9_59==1)
{
l9_58=texture2D(sc_OITAlpha1,l9_48);
l9_57=texture2D(sc_OITDepthLow1,l9_48);
l9_56=texture2D(sc_OITDepthHigh1,l9_48);
}
else
{
l9_58=l9_62;
...
l9_63[6]=l9_49[6];
l9_63[7]=l9_49[7];
unpackValues(l9_56.w,l9_59,l9_63);
unpackValues(l9_56.z,l9_59,l9_63);
unpackValues(l9_56.y,l9_59,l9_63);
unpackValues(l9_56.x,l9_59,l9_63);
unpackValues(l9_57.w,l9_59,l9_63);
unpackValues(l9_57.z,l9_59,l9_63);
unpackValues(l9_57.y,l9_59,l9_63);
unpackValues(l9_57.x,l9_59,l9_63);
int l9_72[8];
l9_72[0]=l9_50[0];
l9_72[1]=l9_50[1];
l9_72[2]=l9_50[2];
...
l9_72[6]=l9_50[6];
l9_72[7]=l9_50[7];
unpackValues(l9_58.w,l9_59,l9_72);
unpackValues(l9_58.z,l9_59,l9_72);
unpackValues(l9_58.y,l9_59,l9_72);
unpackValues(l9_58.x,l9_59,l9_72);
}
l9_55=l9_58;
l9_54=l9_57;
l9_53=l9_56;
...
mediump vec4 l9_77=texture2D(sc_OITFilteredDepthBoundsTexture,l9_48);
vec2 l9_78=l9_77.xy;
int l9_79;
#if (sc_SkinBonesCount>0)
{
...
if (l9_87)
{
vec3 l9_88=l9_81.xyz*(1.0-(float(l9_50[l9_83])/255.0));
